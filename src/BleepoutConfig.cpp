...
_playerInitialLives(5),
_ballOutDecreasesLives(true),
...
void RoundConfig::loadFile(const std::string &path) {
  ...
  _playerInitialLives = settings.getValue("settings:playerInitialLives", _playerInitialLives);
  _ballOutDecreasesLives = settings.getValue("settings:ballOutDecreasesLives", _ballOutDecreasesLives);
  //...
}
...
void RoundConfig::saveFile(const std::string &path) const {
  ...
  settings.setValue("settings:playerInitialLives", _playerInitialLives);
  settings.setValue("settings:ballOutDecreasesLives", _ballOutDecreasesLives);
...
void RoundConfig::loadJsonFile(std::string path) {
  ...
  readJsonVal(root, "playerInitialLives", &_playerInitialLives);
  readJsonVal(root, "ballOutDecreasesLives", &_ballOutDecreasesLives);
}
...
void RoundConfig::saveJsonFile(std::string path) const {
  ...
  root["playerInitialLives"] = _playerInitialLives;
  root["ballOutDecreasesLives"] = _ballOutDecreasesLives;
  writeJsonFile(path, root);
}
